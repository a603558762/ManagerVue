  ...
  <el-container class="home_container">
    ...
    <el-container>
      <el-aside :width="collapse ? '65px': '200px'">
        <div class="zdclass" @click="iscollapse">|||</div>
        <el-menu
...
export default {
  ...
  data() {
    return {
      ...
      IconObj : {
        ...
        "认证和授权":"iconfont icon-collection",
        "Users":"iconfont icon-user-group-fill",
        "Goods":"iconfont icon-service_fill",
        "Trade":"iconfont icon-financial_fill",
        "User_Operation":"iconfont icon-decoration_fill",
        "TyadminBuiltin":"iconfont icon-tools"
      }
    }
  },
  created() {
  ...
  methods: {
    ...
    initData() {
      let _this = this
      request({
        url: "api/xadmin/v1/sys/menu",
        method: "get"
      }).then(function (response) {
        console.log(response.data)
        _this.menuList = response.data.data.filter((item) => {
